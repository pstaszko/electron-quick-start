...
story.Init = () => {
    ...
    var scMugger = story.AddScene(Scene.CreateFunctionScene(() => {
    ...
    var scStore = story.AddScene(Scene.CreateFunctionScene(() => {
    ...
    scShortcut.AddOption(StoryOption.Create("Dick picks up the rubber chicken", scMugger, () => { story.Characters["Dick"].Items.push("rubberchicken") }));
    scShortcut.AddOption(StoryOption.Create("Dick picks up the gun", scMugger, () => { story.Characters["Dick"].Items.push("gun") }));
