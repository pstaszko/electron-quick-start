...
story.Init = () => {
    ...
    var scOgre = story.AddScene(Scene.CreateFunctionScene(() => {
    ...
    var scWell = story.AddScene(Scene.CreateFunctionScene(() => {
    ...
    scShortcut.AddOption(StoryOption.Create("Dick picks up the jester's hat", scOgre, () => { story.Characters["Dick"].Items.push("jesterhat") }));
    scShortcut.AddOption(StoryOption.Create("Dick picks up the sword", scOgre, () => { story.Characters["Dick"].Items.push("sword") }));
